...
/**
 * Modified by huncyrus @ 2014-08-25
 *
 * Note: This autoloader based on the Official Facebook PHP-SDK-4.x autoloader.php file.
 *
 * Dependency:
 *  - PHP 5.4+
 *  - Facebook PHP SDK 4+
...
spl_autoload_register(function ($class) {
  ...
  //$base_dir = defined('FACEBOOK_SDK_V4_SRC_DIR') ? FACEBOOK_SDK_V4_SRC_DIR : __DIR__ . '/libraries/facebook/Facebook/';
  $base_dir = APPPATH . 'libraries/facebook/Facebook/'; // all FB original src stuff copied into libraries/facebook/facebook folder
